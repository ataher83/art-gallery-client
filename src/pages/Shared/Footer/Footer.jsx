      ...
      <div className="container mx-auto ">
        <footer className="footer p-10 bg-base-300 text-base-content">
            ...
            <nav>
                ...
                <a className="link link-hover">Start Your Custom Painting</a>
            ...
            <nav>
                ...
                <a className="link link-hover">The Art Gallery</a>
                <a className="link link-hover">36 xyz Square, Dhaka</a>
                <a className="link link-hover">Tel: 01800-000000</a>
                <a className="link link-hover">Email: hello@theartgallery.com</a>
            </nav> 
            <nav>
